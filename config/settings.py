...
SECRET_KEY = 'django-insecure-=(&)4-81ph3d8ouw&)k-s2(x7@m8r-5+^p)4rp9-c9=esvbhqe'
...
INSTALLED_APPS = [
    ...
    # Third party
    'rest_framework', #it turns your Django app into an API that sends and receives JSON data instead of HTML pages.
